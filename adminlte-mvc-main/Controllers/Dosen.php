...
class Dosen
{
    ...
    public function create($data)
    {
        ...
        return $stmt->execute([
            $data['nidn'], $data['nama'], $data['gelar_belakang'], $data['gelar_depan'],
            $data['jenis_kelamin'], $data['tempat_lahir'], $data['tanggal_lahir'],
            $data['alamat'], $data['email'], $data['tahun_masuk'], $data['prodi_id']
        ]);
    }
    ...
    public function update($id, $data)
    {
        ...
        return $stmt->execute([
            $data['nidn'], $data['nama'], $data['gelar_belakang'], $data['gelar_depan'],
            $data['jenis_kelamin'], $data['tempat_lahir'], $data['tanggal_lahir'],
            $data['alamat'], $data['email'], $data['tahun_masuk'], $data['prodi_id'], $id
        ]);
    }
